...
root_files = glob.glob(f"/afs/cern.ch/user/g/gziemyte/private/CMSSW_13_2_4/src/test/clusteringanalyzer/test/hist_AtoGG_500events125p0Ma2dc15rhoc3delt.root")
...
# C = TCanvas()
# C.cd()
# H_diphoenergyfrac.SetTitle("Energy Fraction (mH = 125 GeV)")
# H_diphoenergyfrac.Draw("hist")
# C.Print("EnergyFractionmH125.root")
